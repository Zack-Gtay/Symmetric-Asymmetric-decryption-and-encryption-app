...
const Des = () => {
  ...
  const handleEncrypt = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/encrypt-des", { plaintext, key })
      .then((response) => {
  ...
  const handleDecrypt = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/decrypt-des", { ciphertext, key })
      .then((response) => {
