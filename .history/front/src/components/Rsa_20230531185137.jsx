...
const Rsa = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-center text-center bg-slate-300">
      <h1>RSA</h1>
      <input
        type="text"
        value={plaintext}
      ...
      />
      <button onClick={handleEncrypt} className='bg-gray-500 w-[30%] self-center mt-2 p-3 rounded-md'>Encrypt</button>
      <br />
