...
const Ecc = () => {
  ...
  const generateKeys = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/generate-keys")
      .then((response) => {
  ...
  const handleEncrypt2 = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/encrypt-with-ecc", {
