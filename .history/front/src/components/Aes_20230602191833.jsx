...
const Aes = () => {
  ...
  const handleEncrypt3 = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/encrypt-with-aes", {
  ...
  const handleDecrypt3 = () => {
    Axios.post("https://symmetric-asymmetric-decryption-and.onrender.com/decrypt-with-aes", {
      secretKey: secretKey,
      iv: iv,
