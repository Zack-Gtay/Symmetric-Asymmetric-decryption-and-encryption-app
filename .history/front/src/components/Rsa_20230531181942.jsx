...
const Rsa = () => {
  ...
  return ( <div     <h1>RSA</h1     <inpu       type="text"      value={plaintext}      onChange={(e) => setPlaintext(e.target.value)}    />    <button onClick={handleEncrypt}>Encrypt</button>    <br />    Encrypted message: {encrypted}    <br />    <button onClick={handleDecrypt}>Decrypt</button>
   <br />
  //     Decrypted message: {decrypted}
   <br />    Response time: {responseTime} ms  </div>
  )
}
