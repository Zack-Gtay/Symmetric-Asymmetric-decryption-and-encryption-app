...
const Rsa = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-center text-center mt-5 gap-3 ">
      ...
      <input
        ...
        className="w-[30%] text-center self-center text-black drop-shadow-md outline-0 rounded-md p"
      />
      <button
        onClick={handleEncrypt}
        className="bg-gray-500 w-[30%] self-center mt-2 p-3 rounded-md text-white"
      >
        Encrypt
      </button>
      <br />
